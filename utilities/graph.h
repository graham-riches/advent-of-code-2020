...
*/
enum class ChildNodes : unsigned { child_a, child_b, total_children };
...
struct Node {
   ...
   */
    bool has_children( void ) {
        return ( this->children[static_cast<int>( ChildNodes::child_a )].size( ) > 0 ) ||
               ( this->children[static_cast<int>( ChildNodes::child_b )].size( ) > 0 );
    }
};
